...
class Template{
  ...
  /**
   * С помощью данного метода нельзя установить переменные окружения шаблона с 
   * именами file и env. Если вам нужны именно эти имена для переменных 
   * окружения шаблона, используйте метод env.
   */
