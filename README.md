# Bricks.TemplateEngine.Php

Пакет реализует простой PHP шаблонизатор с поддержкой переменных.
...
[исходные коды]: https://github.com/Bashka/bricks_templateengine_php/releases
[PHPUnit]: http://phpunit.de/
[обсуждение]: https://github.com/Bashka/bricks_templateengine_php/issues
